...
function lookup(ids, idField, country, lang, requestOptions) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var langParam, joinedIds, url, data, filtered;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    langParam = lang ? "&lang=" + lang : "";
                    joinedIds = ids.join(",");
                    url = LOOKUP_URL + "?" + idField + "=" + joinedIds + "&country=" + country + "&entity=software" + langParam;
                    return [4 /*yield*/, axios_1.default.get(url, __assign({}, requestOptions))];
                case 1:
                    data = (_a.sent()).data;
                    filtered = data.results.filter(function (app) {
                        return (typeof app.wrapperType === "undefined" || app.wrapperType === "software");
                    });
                    return [2 /*return*/, filtered.map(cleanApp)];
            }
        });
    });
}
